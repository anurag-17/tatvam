...
export default function App() {
  ...
  const getData = () => {
   fetch('https://controlf5.co.in/client-demo/react-wordpress/wp-json/wp/v2/gallery_slider/')
...
useEffect(() => {
               ...
               const gallerycondata = await fetch('https://controlf5.co.in/client-demo/react-wordpress/wp-json/wp/v2/pages/33');
